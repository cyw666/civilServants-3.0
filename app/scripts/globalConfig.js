...
var ALL_PORT = {
  ...
  NoticeList:{
    ...
    data:{page:'1',rows:'9',sort:'Id',order:'desc',categoryId:0,titleNav:'通告列表',wordLimt:'35'}
  },
  //通知内容
  noticeContent:{
  ...
  CourseClickRank:{
    ...
    data:{page:1,rows:19,sort:'ClickCount',order:'desc',courseType:'All',flag:'All',titleNav:'课程排行',wordLimt:35}
  },
  //课程点击排行详细页
  CourseClickList:{
